...
angular.module('starter.controllers', [])
  ...
  .controller('AppCtrl', function ($scope, $ionicModal, $timeout, $http) {
    ...
    $scope.checkAuth = function(){
        $scope.sendCredentials=  JSON.parse(localStorage.getItem('auth'));
        $scope.itemCredentials=  localStorage.getItem('auth');
        if( $scope.itemCredentials !=="" && $scope.itemCredentials.status !=="error"){
          console.log($scope.itemCredentials.username);
        }
        else{
          $scope.login();
        }
